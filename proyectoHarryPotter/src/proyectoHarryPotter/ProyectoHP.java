			...
			if (passwd.equals("lemondrop")) {
				...
				do {
					...
					case "3":
						...
						System.out.println("\n\n"); // Espacio para separar de la carta anterior

						System.out.println();
						System.out.println("========================================================");
						System.out.println("||          LLEGADA AL CASTILLO DE HOGWARTS           ||");
						System.out.println("========================================================");
						System.out.println(
								"Has cruzado el lago negro y entras al Gran Comedor bajo las velas flotantes.");
						System.out.println("Antes de disfrutar del banquete, debes pasar una prueba crucial.");
						System.out
								.println("El Sombrero Seleccionador te espera en el taburete para decidir tu destino.");
						System.out.println("Acércate y responde con sinceridad...");
						System.out.println();
						...
						while (vida > 0 && vidaMago > 0) {
								...
								if (accion == 1) {
									...
									if (opcionAtaque >= 1 && opcionAtaque <= inventarioHechizos.size()) {
										...
										if (resultado == 0) {
											...
											System.out.println(
													">> ¡Impacto Directo! El Mago recibe " + danioFinal + " de daño.");
										} else if (resultado == 1) {
											danioFinal = danioBase / 2;
											System.out
													.println(">> El Mago se cubre. Recibe " + danioFinal + " de daño.");
										} else {
										...
										if (esMyrtle && ataqueSeleccionado == ("Anima Vinculus") && resultado == 0
												|| resultado == 1 && vida < 45 && vidaMago < 100) {
										...
										if (vidaMago < 50 && vidaMago > 0) {
											System.out
													.println("¡Los hechizos del Mago se han potenciado por la rabia!");
										}
							...
							// ------------------- TURNO DEL MAGO (ENEMIGO) -------------------
								...
								if (resultado == 0) {
									danioFinal = danioBase;
									System.out
											.println(">> ¡Te golpea brutalmente! Recibes " + danioFinal + " de daño.");
								} else if (resultado == 1) {
									danioFinal = danioBase / 2;
									System.out
											.println(">> Te cubres a tiempo. Recibes solo " + danioFinal + " de daño.");
								} else {
					...
					case "Bosque Prohibido":
						...
						case "1":
							...
							while (vida > 0 && vidaTula > 0) {
								...
								if (turnoJugador) {
									System.out.println("\n------------------------------------------------");
									System.out.println("TU TURNO | Vida: " + vida + " | Acromántula: " + vidaTula);
									System.out.println("¿Qué quieres hacer?");
									System.out.println("1. Atacar");
									System.out.println("2. Usar Objeto");
									...
									if (accion == 1) {
										...
										if (opcionAtaque >= 1 && opcionAtaque <= inventarioHechizos.size()) {
											...
											if (resultado == 0) {
												...
												danioFinal = danioBase / 2;
												System.out.println(">> La Acromántula se cubre. Recibe " + danioFinal
														+ " de daño.");
											} else {
						...
						case "1":
							...
							if (inventarioHechizosMO.contains("Lumos")) {
								...
								if (esEstudiante) {
									...
									System.out.println("Neville: ¿Quién es el fundador de tu casa (" + casa + ")?");
