			...
			if (passwd.equals("jugones")) {
				...
				while (explorando) {
					...
					case "Gran Comedor":
						...
						//tengo dudas si mola mas que se vea lo de recuperar vidas o si mola mas sin eso y que el usuario lo vea cuando lo elija 
					...
					case "Bosque Prohibido":
						...
						System.out.println("1. Adentrarse en lo profundo"); // esto daria lugar a pelea
