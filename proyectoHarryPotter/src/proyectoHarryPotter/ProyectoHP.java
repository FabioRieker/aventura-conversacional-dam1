                ...
                do {
                    ...
                    switch (personaje) {
                        ...
                        case "3":
                            ...
                            valido = true;
                            // gorro seleccionadorSystem.out.println("Bienvenido al gorro seleccionador");
                    		
                    		//contador para puntuacion 
                    		int slytherin = 0;
                    		int ravenclaw = 0;
                    		int hufflepuff = 0;
                    		int gryffindor = 0;
                    		// preguntas del gorro seleccionador con switch cases y luego un comparador de variables
                    		// Pregunta 1
                    		// Pregunta 1
                    		boolean valido1;
                    		do {
                    		    ...
                    		    switch (opcion) {
                    		        ...
                    		        case "2": ravenclaw++; break;
                    		        case "3": gryffindor++; break;
                    		        case "4": slytherin++; break;
                    		        default: System.out.println("No has marcado bien la puntuación, vuelve a intentarlo."); valido1 = false; break;
                    		    }
                    		} while (!valido1);
                    		...
                    		do {
                    		    ...
                    		    switch (opcion1) {
                    		        case "1": ravenclaw++; break;
                    		        case "2": gryffindor++; break;
                    		        case "3": hufflepuff++; break;
                    		        case "4": slytherin++; break;
                    		        default: System.out.println("No has marcado bien la puntuación, vuelve a intentarlo."); valido1 = false; break;
                    		    }
                    		} while (!valido1);
